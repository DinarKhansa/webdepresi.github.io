...
<body>
    ...
    <div class="chat-bar-collapsible">
        <button id="chat-button" type="button" class="collapsible">Chatbot Terapi Virtual
            ...
            <div class="full-chat-block">
                ...
                <div class="outer-container">
                    <div class="chat-container">
                        <!-- chats -->
                        <div id="chatbox">
                        <iframe src="https://web.powerva.microsoft.com/environments/Default-d7b95ec4-9a7f-4260-b2e3-eb53f0ac8401/bots/crdf2_bot1uPECdk/webchat?__version__=2" frameborder="0"></iframe>
                        </div>
